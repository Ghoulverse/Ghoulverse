...
export const GHOULS: Ghoul[] = [
  ...
  },
  {
    id: "baby",
    name: "BABY GHOUL",
    tagline: "Small Hands, Big Clean",
    description: "Teaching the next generation that cleaning can be fun! BABY GHOUL creates safe, non-irritating DIY cleaning kits for kids.",
    longDescription: "BABY GHOUL is proof that size is not strength — curiosity is. With chubby hands and wide eyes, BABY GHOUL approaches every spill like a scientist and every stain like a puzzle. The products are gentle. The methods are simple. But the results? Spotless. BABY GHOUL teaches children that cleaning is not punishment — it is play. It is discovery. It is the first step toward mastering your own world.",
    color: "blue",
    colorHex: "#3b82f6",
    icon: "🍼",
    position: { x: 85, y: 50 },
    products: ["DIY Cleaning Kit", "Toy Sanitizer", "Spill-Proof Spray Bottle", "Color-Changing Cleaners", "Safety-First Wipes"],
